...
# from minxuan.attention_net import GTrXLNet
...
def reward_adapter(env_obs, env_reward):
    ...
    # print()
    # plt.imshow(env_obs.top_down_rgb.data)
    # plt.show()
    ...
    # preferred speed = 10 m/s
    speed_reward = 5 *  np.sum(10 - np.abs(np.array([1.0 * env_obs.ego_vehicle_state.speed], dtype=object) - 10))
...
rllib_agent = {
    "agent_spec": AgentSpec(
        interface=AgentInterface.from_type(AgentType.Laner, max_episode_steps=500),
        agent_params={
